  ...
  var version = "/v06/6-2-7";
    ...
    */
    ...
    router.post(foreignproperty + 'select-country/countries-list2', function (req, res) {
     ...
     router.post(foreignproperty + 'select-country/pia-or-expenses', function (req, res) {
          res.redirect('cya')
     })
...
router.post(fpspr + 'income/opr-userpremiums-grant-lease-yn', function (req, res) {
  if(req.session.data['opr-userpremiums-grant-lease-yn'] == 'No'){
    res.redirect('opr-reverse-premiums')
  }
  else{
...
*/
  ...
  */
  ...
  // other FHL
  router.post(fhlukabout + 'pia-or-expenses', function (req, res) {
    if(req.session.data['pia-or-expenses'] == "PIA"){
